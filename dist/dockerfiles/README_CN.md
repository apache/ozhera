...
docker build  . --build-arg SRC_PATH=servers/ozhera-app/ --build-arg LIB_PATH=.  --build-arg APP_VERSION=2.2.6-incubating -t  herahub/opensource-pub:app-server-2.2.6-incubating-beta-v1
