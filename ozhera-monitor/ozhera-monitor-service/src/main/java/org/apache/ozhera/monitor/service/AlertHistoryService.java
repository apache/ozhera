...
public interface AlertHistoryService {
    ...
    Result<PageData<List<AlertHistory>>> metricList(String user, AlertHistoryParam param);
    
    Result<AlertHistoryDetailed> metricDetailed(String user, AlertHistoryParam param);
    
    Result metricResolved(String user, AlertHistoryParam param);
