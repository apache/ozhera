...
{
"exemplar": true,
"expr": "sum(process_runtime_go_mem_heap_alloc{serverEnv=~\"$serverEnv\", application=\"$application\", serverIp=~\"$instance\"}) by (serverIp)",
"interval": "",
...
{
"exemplar": true,
"expr": "sum(process_runtime_go_mem_heap_sys{serverEnv=~\"$serverEnv\", application=\"$application\", serverIp=~\"$instance\"}) by (serverIp)",
"hide": false,
"interval": "",
...
{
"exemplar": true,
"expr": "sum(process_runtime_go_mem_heap_idle{serverEnv=~\"$serverEnv\", application=\"$application\", serverIp=~\"$instance\"}) by (serverIp)",
"hide": false,
"interval": "",
...
{
"exemplar": true,
"expr": "sum(process_runtime_go_mem_heap_inuse{serverEnv=~\"$serverEnv\", application=\"$application\", serverIp=~\"$instance\"}) by (serverIp)",
"hide": false,
"interval": "",
...
{
"exemplar": true,
"expr": "sum(rate(process_runtime_go_mem_heap_alloc{serverEnv=~\"$serverEnv\", application=\"$application\", serverIp=~\"$instance\"}[2m])) by (serverIp)",
"interval": "",
"legendFormat": "{{serverIp}}-alloc",
"refId": "A",
"datasource": {
