...
"editorMode": "code",
"exemplar": true,
"expr": "sum(container_last_seen{application=\"$application\",podIp=~\"$Node\",image!=\"\"}) by (podIp)",
"format": "table",
"hide": false,
"instant": true,
"interval": "",
...
"editorMode": "code",
"exemplar": true,
"expr": "container_spec_cpu_quota{system=\"mione\" ,podIp=~\"$Node\",application=\"$application\"} / container_spec_cpu_period{system=\"mione\" ,podIp=~\"$Node\",application=\"$application\"}",
"format": "table",
"hide": false,
"instant": true,
"interval": "",
...
"editorMode": "code",
"exemplar": true,
"expr": "sum(irate(container_cpu_usage_seconds_total{image!=\"\",podIp=~\"$Node\",application=\"$application\"}[1m])) without (cpu) * 100",
"format": "table",
"hide": false,
"instant": true,
"interval": "",
...
"editorMode": "code",
"exemplar": true,
"expr": "container_memory_rss{image!=\"\",podIp=~\"$Node\",application=\"$application\"} / container_spec_memory_limit_bytes{image!=\"\",podIp=~\"$Node\",application=\"$application\"}",
"format": "table",
"hide": false,
"instant": true,
"interval": "",
...
"editorMode": "code",
"exemplar": true,
"expr": "sum(container_memory_usage_bytes{application=\"$application\",podIp=~\"$Node\",image!=\"\"}) by (podIp) - sum(container_memory_cache{application=\"$application\",podIp=~\"$Node\",image!=\"\"}) by (podIp)",
"format": "table",
"hide": false,
"instant": true,
"interval": "",
...
"editorMode": "code",
"exemplar": true,
"expr": "sum(container_spec_memory_limit_bytes{podIp=~\"$Node\",application=\"$application\"}) by (instance)",
"format": "table",
"hide": false,
"instant": true,
"interval": "",
...
"editorMode": "code",
"exemplar": true,
"expr": "sum(irate(container_cpu_usage_seconds_total{image!=\"\",podIp=~\"$Node\",application=\"$application\"}[1m])) without (cpu) * 100 / (container_spec_cpu_quota{system=\"mione\" ,podIp=~\"$Node\",application=\"$application\"} / container_spec_cpu_period{system=\"mione\" ,podIp=~\"$Node\",application=\"$application\"})",
"hide": false,
"interval": "",
"legendFormat": "{{ip}}",
"range": true,
...
"definition": "label_values(container_last_seen{application=~\"$application\"},podIp)",
"hide": 0,
"includeAll": true,
"label": "节点",
"multi": true,
...
"options": [],
"query": {
"query": "label_values(container_last_seen{application=~\"$application\"},podIp)",
"refId": "StandardVariableQuery"
},
"refresh": 2,
"regex": "",
