...
public class MetricsParseResult {
    ...
    public MetricsParseResult(JaegerTracerDomain jaegerTracerDomain, DriverDomain driverDomain, boolean ignore, boolean isValidate, HeraTraceEtlConfig heraTraceEtlConfig, boolean excludeApplicationOpen){
